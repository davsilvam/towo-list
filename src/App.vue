...
<template>
  <div class="relative z-0 min-h-screen overflow-hidden bg-neutral-900">
    <img :src="gradient_src" class="absolute left-[-20%] -z-10 opacity-50 sm:left-0">
    <img :src="gradient_2_src" class="absolute bottom-[-35%] -z-10 opacity-50 sm:bottom-[-120%]">

    <main class="flex flex-col gap-10 px-8 py-20 text-neutral-50 md:px-16 lg:px-20 xl:px-40">
      <div class="space-y-8">
